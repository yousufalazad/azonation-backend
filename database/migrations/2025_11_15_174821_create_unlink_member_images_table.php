...
return new class extends Migration
{
    ...
    {
       Schema::create('unlink_member_images', function (Blueprint $table) {
            $table->id();
            // Foreign key referencing the office_records table
            $table->foreignId('unlink_member_id')
                ->constrained('unlink_members')
                ->onDelete('cascade')
                ->comment('unlink_member primary id');
    ...
    {
        Schema::dropIfExists('unlink_member_images');
    }
};
