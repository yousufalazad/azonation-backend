...
return new class extends Migration
{
    ...
    {
        Schema::create('year_plan_images', function (Blueprint $table) {
            $table->id();

            // Foreign key referencing the office_records table
            $table->foreignId('year_plan_id')
                ->constrained('year_plans')
                ->onDelete('cascade')
                ->comment('year_plans primary id');
    ...
    {
        Schema::dropIfExists('year_plan_images');
    }
};
