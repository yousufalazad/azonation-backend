...
return new class extends Migration
{
    ...
    {
        Schema::create('management_packages', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('max_member')->default(10)->comment('Maximum number of active members allowed in the package');
            ...
            $table->boolean('is_active')->default(true)->comment('Indicates if the package is active or not');
    ...
    {
        Schema::dropIfExists('management_packages');
    }
};
