...
return new class extends Migration
{
    ...
    {
        Schema::create('strategic_plan_images', function (Blueprint $table) {
            $table->id();
            
            // Foreign key referencing the office_records table
            $table->foreignId('strategic_plan_id')
                ->constrained('strategic_plans')
                ->onDelete('cascade')
                ->comment('strategic_plans primary id');
    ...
    {
        Schema::dropIfExists('strategic_plan_images');
    }
};
