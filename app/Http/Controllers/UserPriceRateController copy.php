...
class UserPriceRateController extends Controller
{
    ...
    public function getAllUserPriceRates()
    {
        try {
            // Retrieve the authenticated user's ID
            //$user_id = $request->user()->id;

            // Fetch package_id, country_id, and currency_code for all user
            $packageIdAndCountryData = User::where('users.activation_status', 'active')
