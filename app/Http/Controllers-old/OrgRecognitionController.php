...
use App\Models\OrgRecognition; // Assuming the model is called OrgRecognition
...
class OrgRecognitionController extends Controller
{
    ...
    {
        try {
            $recognitions = OrgRecognition::get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $recognition = OrgRecognition::create([
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $recognition = OrgRecognition::where('id', $id)->first();
